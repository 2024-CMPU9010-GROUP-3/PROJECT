...
\begin{enumerate}
    \item Onboarding feature implementation
          \begin{itemize}
              ...
              \item Due to the limitation of the feature, we are not able to make this interaction possible. However, a deeper black was added to the screen overlay (figure 3.1) to better indicate
                    that elements are not clickable. Gifs were also added to the onboarding elements (figure 3.2) to indicate what each
                    button does.
                    \begin{figure}
                        \centering
