...
\begin{enumerate}
    ...
    \item \underline{Baseline \& Evaluation metrics:} No baseline; user
          experience will be evaluated on range of metrics below (table of features to be assessed) and a user experience survey (figure 2.2 - should i make a different one?)\\
