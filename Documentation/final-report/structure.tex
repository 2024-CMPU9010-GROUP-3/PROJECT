...
\usepackage[outputdir=docs]{minted} % Required for including snippets of code
...
\renewcommand{\footrule}{\color{tudublinblue}\hrule width \headwidth height \footrulewidth}
...
% Headers
\lhead{} % Left header
\chead{\fontfamily{phv}\selectfont\textit{\textcolor{tudublinblue}\thetitle}} % Center header - currently printing the article title
\rhead{} % Right header

% Footers
\lfoot{} % Left footer
\cfoot{} % Center footer
\rfoot{\fontfamily{phv}\selectfont\footnotesize\textcolor{tudublinblue}{Page \thepage\ of \pageref{LastPage}}} % Right footer, "Page 1 of 2"
...
% dots connecting to page numbers
...
\renewcommand{\cftsubsubsecfont}{\fontfamily{phv}\selectfont\itshape}
\renewcommand{\cftsubsubsecpagefont}{\fontfamily{phv}\selectfont}
