...
Define precision, recall, f1 score, common metrics and write formulas and cite papers where they are defined...
...
The classification is evaluated on the following metrics: Average Intersection over Union (IoU), Balanced Accuracy and Precision, Recall, F1 Score, Accuracy, Specificity per class.
Define IoU and other metrics and write formulas and cite papers where they are defined...
These metrics are saved in a csv file for each test image as well as the overall average metrics on the entire test set.
...
Explain additional metrics how they are calculated/ what they represent.
...
Relire tout and add more, ajouter toutes les figures.
