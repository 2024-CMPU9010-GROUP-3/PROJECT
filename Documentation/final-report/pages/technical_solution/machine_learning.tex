...
\begin{table}[h!]
    ...
    \begin{tabular}{cc}
        ...
        \includegraphics[width=0.4\textwidth]{images/image7_classification_test_set.png} & \includegraphics[width=0.4\textwidth]{images/image8_classification_test_set.png} \\
    \end{tabular}
