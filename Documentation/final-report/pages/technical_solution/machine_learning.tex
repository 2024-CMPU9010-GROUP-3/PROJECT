...
Parking spots are classified as parking lots, when clusters of 18 or more spots are identified in an image. Larger clusters are prioratized as parking lots containing less spots are not as important and given that the threshold of 18 spots, avoids misclassifications. (Expliquer mieux)
