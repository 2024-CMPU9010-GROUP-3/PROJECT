...
\begin{figure}
    \centering
    \includegraphics[width=0.4\textwidth]{images/sitemap.png}
...
\textbf{Top section}
\begin{itemize}
    \item \textbf{Logo and Title:} At the top-right corner, you’ll see the Magpie logo and the dashboard title, "Magpie Dashboard: v0.12.0," followed by the tagline "Services at a glance." This establishes the page's purpose and provides visual identity to the platform.
\end{itemize}
