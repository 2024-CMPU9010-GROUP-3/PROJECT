...
We used both controlled \& uncontrolled approaches for the sessions.\\
The controlled sessions were based around a strict list of tasks the user would complete and we would look at metrics such as time taken, difficulty and task success rate.\\
...
The difficulty of the task is related to task completion and how much a user struggled during it. The status of a task can either be "complete", "pass", or "fail" where "complete" is attributed when the user does the task on their own, "pass" is attributed when the user was able to complete the task but with our help, and "fail" when the user were not able to do the task even with our help. \\\\
