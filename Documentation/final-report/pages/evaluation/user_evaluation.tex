...
\noindent We used both controlled \& uncontrolled approaches for the sessions.\\
...
\noindent The difficulty of the task is related to its status and how much a time a user took during it. The status of a task can either be "complete", "pass", or "fail" where:
\begin{itemize}
...
\end{itemize}
In addition, the user's behaviour is observed to give us indications on their thought process and their intuition going through the application.\\\\
