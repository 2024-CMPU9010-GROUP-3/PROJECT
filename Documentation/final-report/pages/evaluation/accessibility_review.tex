...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{images/old-icons-map.png}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{images/accessb-survey-components.png}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{images/accessb-survey-design.png}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{images/accessb-survey-interaction.png}}
