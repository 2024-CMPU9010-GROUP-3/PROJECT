...
The accessibility general guidelines we'll be evaluating Magpie on are mostly derived from the EU Web Accessibility Directive.\\
The EU Web Accessibility Directive came into effect at the end of 2016 and aims to \emph{make public sector websites and mobile applications more accessible, and to harmonise varying standards within the European Union (...)}(\cite{webaccessibilitydirective2016}).\\\\
