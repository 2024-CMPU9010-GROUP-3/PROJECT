...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/accessb-survey-components.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/accessb-survey-design.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/accessb-survey-interaction.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/accessb-survey-summary.png}}
