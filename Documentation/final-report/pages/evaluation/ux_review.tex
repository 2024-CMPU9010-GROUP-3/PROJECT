The goal of this review is to evaluate the user interface of Magpie at different
...
The questionnaire is divided into 3 sections pertaining to \emph{visual design},
...
In addition, she suggested there should be an option to exit the tutorial at any
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{images/old-dashboard_opt.png}}
...
The second section covers the information architecture and data quality of the
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{images/ux-survey1-q8.png}}
...
Andrea Curley found our interface sleek and minimalistic. However,
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.6\textwidth]{images/landing-page-current.png}}
...
Some suggestions to improve user experience would be to make the amenity row
clickable so as to make it easier for the user to select and deselect it, as
opposed to having to click the eye directly.
%new page dashboard
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{images/dashboard-current.png}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/search-results-fail.png}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/search-results-parnell.png}}
...
\begin{figure}[h!]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/saved-locations.png}}
    \caption{V.0.12 Magpie Saved Location}
\end{figure}

Last suggestion on this point is to be able to press enter to start the search,
