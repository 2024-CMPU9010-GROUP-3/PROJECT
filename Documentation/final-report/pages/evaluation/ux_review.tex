...
A professor at a top technological university, specialised in web development, web design and user experience, she has consulted on many notable project such as \fcolorbox{yellow}{yellow}{EXAMPLE}.\\
...
UI design guidelines differ from UX ones because of their fundamental differences: one is user based and the other isn't.\\

\textbf{UI design} aims to create a visually appealing, intuitive and user\-friendly interface that allows for easy navigation and interaction with the application.\\
...
The 10 guidelines was devised in the 1990's by Jakob Nielsen, and today are still the basis for all UI and UX design processes (\cite{uiuxguidelinesnielsen2016}). Below are the ones most relevant to Magpie's development:
\begin{itemize}
...
\begin{enumerate}
    ...
    \item Free\-roaming of the application
    \item Discussion
    \item Questionnaire \& end of review
\end{enumerate}
The questionnaire is divided into 3 sections pertaining to visual design, information architecture, and compliance as shown in the table below.\\
Different types of questions were included, such as "Closed" "Scale" and "Open" to allow for both the quantitative and qualitative measure of Magpie. \fcolorbox{yellow}{yellow}{SUPPORTING EVIDENCE ON MIXED SURVEY QUESTIONS}\\ \\
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{images/landing-page-current.png}}
...
%new page following session 1 feedback
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.7\textwidth]{images/dashboard-current.png}}
...
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{images/map-icons-group.png}}
