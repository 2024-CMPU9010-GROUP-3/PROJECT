We requested a review of our system from UI/UX professional Andrea Curley. The goal of this review is to evaluate the user interface of Magpie at different stages of development and rate its user-friendliness in regards to key UI/UX general guidelines.\\
...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{0.05\textwidth}|p{0.8\textwidth}|p{0.15\textwidth}|}
        \hline
...
%figure of 1st survey responses
\begin{figure}
    \centering
    \fbox{\includegraphics[width=0.5\textwidth]{images/old-login-error.png}}
    \caption{Error when inputting non-existant username and password}
