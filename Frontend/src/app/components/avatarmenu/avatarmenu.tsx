...
export function DropdownMenuDemo() {
  const { sessionToken, setSessionToken, setSessionUUID, sessionUUID } =
    useSession();
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        {sessionToken ? (
          <Avatar>
            <AvatarImage
              src="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0&icon_names=home"
              alt="@shadcn"
            />
            <AvatarFallback>
              <svg
        ...
        {sessionToken ? (
          <>
            ...
            <DropdownMenuItem>
              ...
              <Link href={`/history?userid=${sessionUUID}`}>History</Link>
            </DropdownMenuItem>
            <DropdownMenuSeparator />
